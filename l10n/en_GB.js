OC.L10N.register(
    ...
    "Managed project folders (recommended)" : "Managed project folders (recommended)",
    "Automatically managed folders" : "Automatically managed folders",
    "We recommend using this functionality but it is not mandatory. Please activate in case you want to use the automatic creation and management of project folders." : "We recommend using this functionality but it is not mandatory. Please activate in case you want to use the automatic creation and management of project folders.",
    ...
    "Active" : "Active",
    "Inactive" : "Inactive",
    "Edit managed project folders" : "Edit managed project folders",
    ...
    "Keep current change" : "Keep current change",
    "Complete without group folder setup" : "Complete without group folder setup",
    ...
    "This value is only visible now and then never again. Copy this password to OpenProject {htmlLink} as an Administrator." : "This value is only visible now and then never again. Copy this password to OpenProject {htmlLink} as an Administrator.",
    "Please make sure to rename the group folder or completely delete the previous one or deactivate the automatically managed folders." : "Please make sure to rename the group folder or completely delete the previous one or deactivate the automatically managed folders.",
    "Please install the group folder to be able to use automatic managed folders or deactivate the automatically managed folders." : "Please install the group folder to be able to use automatic managed folders or deactivate the automatically managed folders.",
    "Please make sure to completely delete the previous user or deactivate the automatically managed folders." : "Please make sure to completely delete the previous user or deactivate the automatically managed folders.",
    "Please make sure to completely delete the previous group or deactivate the automatically managed folders." : "Please make sure to completely delete the previous group or deactivate the automatically managed folders.",
    "Something went wrong during groupfolder setup. Deactivate the automatically managed folders." : "Something went wrong during groupfolder setup. Deactivate the automatically managed folders.",
