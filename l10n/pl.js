OC.L10N.register(
    ...
    "This application deeply integrates with the open source project management software OpenProject. It allows linking files and folders in Nextcloud with work packages in OpenProject. In OpenProject, you can see all files related to a work package, and in Nextcloud, you can find all work packages linked to a file. Your project teams gain productivity as they clearly know where to find and store the files that they need for finishing a work package. Further, it extends the Nextcloud dashboard with a widget for personal notifications from OpenProject. The app can also extend the search function in Nextcloud to find work packages in OpenProject." : "Aplikacja ta jest głęboko zintegrowana z oprogramowaniem OpenProject do zarządzania projektami o otwartym kodzie źródłowym. Umożliwia łączenie plików i katalogów w Nextcloud z pakietami roboczymi w OpenProject. W OpenProject możesz zobaczyć wszystkie pliki związane z pakietem roboczym, a w Nextcloud możesz znaleźć wszystkie pakiety robocze połączone z plikiem. Twoje zespoły projektowe zyskują produktywność, ponieważ w wyraźny sposób wiedzą, gdzie znaleźć i przechowywać pliki potrzebne do ukończenia pakietu roboczego. Ponadto rozszerza pulpit nawigacyjny Nextcloud o widżet do osobistych powiadomień z OpenProject. Aplikacja może również rozszerzyć funkcję wyszukiwania w Nextcloud, aby znaleźć pakiety robocze w OpenProject.",
