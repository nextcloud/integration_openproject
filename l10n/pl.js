OC.L10N.register(
    ...
    "This application enables seamless integration with open source project management and collaboration software OpenProject. On the Nextcloud end, it allows users to:\n\n* Link files and folders with work packages in OpenProject\n* Find all work packages linked to a file or folder\n* Keep an eye on updates to your work packages via the dashboard\n* Find relevant work packages using Nextcloud's search bar\n\nOn the OpenProject end, users are able to:\n\n* View all Nextcloud files linked to a work package\n* Download linked files or open them in Nextcloud to edit them\n* Unlink linked files\n\nFor more information on how to set up and use the OpenProject application, please refer to [integration setup guide](https://www.openproject.org/docs/system-admin-guide/integrations/nextcloud/) for administrators and [the user guide](https://www.openproject.org/docs/user-guide/nextcloud-integration/)." : "Aplikacja ta umożliwia bezproblemową integrację z oprogramowaniem OpenProject do zarządzania projektami i współpracy typu open source. Po stronie Nextcloud umożliwia użytkownikom:\n\n* Połączyć pliki i katalogi z pakietami roboczymi w OpenProject\n* Znaleźć wszystkie pakiety robocze połączone z plikiem lub katalogiem\n* Mieć oko na aktualizacje swoich pakietów roboczych za pośrednictwem pulpitu nawigacyjnego\n* Znaleźć odpowiednie pakiety robocze za pomocą paska wyszukiwania Nextcloud\n\nPo stronie OpenProject użytkownicy mogą:\n\n* Zobaczyć wszystkie pliki Nextcloud połączone z pakietem roboczym\n* Pobrać połączone pliki lub otwórzyć je w Nextcloud, aby je edytować\n* Odłączyć połączone pliki\n\nAby uzyskać więcej informacji na temat konfigurowania i korzystania z aplikacji OpenProject, zapoznaj się z [przewodnikiem konfiguracji integracji](https://www.openproject.org/docs/system-admin-guide/integrations/nextcloud/) dla administratorów i z [podręcznikiem użytkownika](https://www.openproject.org/docs/user-guide/nextcloud-integration/).",
    ...
    "OpenProject OAuth client ID" : "ID klienta OAuth OpenProject",
    "OpenProject OAuth client secret" : "Tajny klucz klienta OAuth OpenProject",
    "Replace OpenProject OAuth values" : "Zastąp wartości OAuth OpenProject",
    "Nextcloud OAuth client" : "Klient OAuth Nextcloud",
    "Nextcloud OAuth client ID" : "ID klienta OAuth Nextcloud",
    "Nextcloud OAuth client secret" : "Tajny klucz klienta OAuth Nextcloud",
