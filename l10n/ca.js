OC.L10N.register(
    ...
    "This application enables seamless integration with open source project management and collaboration software OpenProject. On the Nextcloud end, it allows users to:\n\n* Link files and folders with work packages in OpenProject\n* Find all work packages linked to a file or folder\n* Keep an eye on updates to your work packages via the dashboard\n* Find relevant work packages using Nextcloud's search bar\n\nOn the OpenProject end, users are able to:\n\n* View all Nextcloud files linked to a work package\n* Download linked files or open them in Nextcloud to edit them\n* Unlink linked files\n\nFor more information on how to set up and use the OpenProject application, please refer to [integration setup guide](https://www.openproject.org/docs/system-admin-guide/integrations/nextcloud/) for administrators and [the user guide](https://www.openproject.org/docs/user-guide/nextcloud-integration/)." : "Aquesta aplicació permet una integració perfecta amb el programari de col·laboració i gestió de projectes de codi obert OpenProject. Al costat de Nextcloud, permet als usuaris:\n\n* Enllaçar fitxers i carpetes amb paquets de treball a OpenProject\n* Trobeu tots els paquets de treball enllaçats a un fitxer o carpeta\n* Estigueu atents a les actualitzacions dels vostres paquets de treball mitjançant el tauler\n* Trobeu paquets de treball rellevants mitjançant la barra de cerca de Nextcloud\n\nAl costat d'OpenProject, els usuaris poden:\n\n* Veure tots els fitxers Nextcloud enllaçats a un paquet de treball\n* Baixeu fitxers enllaçats o obriu-los a Nextcloud per editar-los\n* Desenllaçar fitxers enllaçats\n\nPer obtenir més informació sobre com configurar i utilitzar l'aplicació OpenProject, consulteu [guia de configuració d'integració](https://www.openproject.org/docs/system-admin-guide/integrations/nextcloud/) per a administradors i [la guia de l'usuari](https://www.openproject.org/docs/user-guide/nextcloud-integration/).",
    ...
    "This application enables seamless integration with open source project management and collaboration software OpenProject. \n\t\nOn the Nextcloud end, it allows users to:\n\n* Link files and folders with work packages in OpenProject\n* Find all work packages linked to a file or a folder\n* View OpenProject notifications via the dashboard\n* Search for work packages using Nextcloud's search bar\n\nOn the OpenProject end, users are able to:\n\n* View all Nextcloud files and folders linked to a work package\n* Download linked files or open them in Nextcloud to edit them\n\nFor more information on how to set up and use the OpenProject application, please refer to [integration setup guide](https://www.openproject.org/docs/system-admin-guide/integrations/nextcloud/) for administrators and [the user guide](https://www.openproject.org/docs/user-guide/nextcloud-integration/)." : "Aquesta aplicació permet una integració perfecta amb el programari de col·laboració i gestió de projectes de codi obert OpenProject.\n\nAl costat de Nextcloud, permet als usuaris:\n\n* Enllaçar fitxers i carpetes amb paquets de treball a OpenProject\n* Trobeu tots els paquets de treball enllaçats a un fitxer o una carpeta\n* Consulteu les notificacions d'OpenProject a través del tauler\n* Cerqueu paquets de treball mitjançant la barra de cerca de Nextcloud\n\nAl costat d'OpenProject, els usuaris poden:\n\n* Veure tots els fitxers i carpetes Nextcloud enllaçats a un paquet de treball\n* Baixeu fitxers enllaçats o obrir-los a Nextcloud per editar-los\n\nPer obtenir més informació sobre com configurar i utilitzar l'aplicació OpenProject, consulteu [guia de configuració d'integració](https://www.openproject.org/docs/system-admin-guide/integrations/nextcloud/) per a administradors i [la guia de l'usuari](https://www.openproject.org/docs/user-guide/nextcloud-integration/)."
},
