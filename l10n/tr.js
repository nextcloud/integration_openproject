OC.L10N.register(
    ...
    "We recommend using this functionality but it is not mandatory. Please activate it in case you want to use the automatic creation and management of project folders." : "Bu özelliği kullanmanızı öneririz, ancak zorunlu değildir. Bu seçenek etkinleştirildiğinde, proje klasörleri otomatik olarak oluşturulur ve yönetilir.",
    ...
    "The app will never delete files or folders, even if you deactivate this later." : "Uygulama, daha sonra devre dışı bıraksanız bile asla dosya veya klasörleri silmez.",
    ...
    "To be able to use an OpenProject server with a local address, enable the `allow_local_remote_servers` setting. {htmlLink}." : "OpenProject sunucusunu yerel bir adres ile kullanabilmek için `allow_local_remote_servers` seçeneğini etkinleştirin. {htmlLink}.",
