OC.L10N.register(
    ...
    "This direct download link is invalid or has expired" : "Bu doğrudan indirme bağlantısı geçersiz ya da süresi geçmiş",
    ...
    "This application deeply integrates with the open source project management software OpenProject. It allows linking files and folders in Nextcloud with work packages in OpenProject. In OpenProject, you can see all files related to a work package, and in Nextcloud, you can find all work packages linked to a file. Your project teams gain productivity as they clearly know where to find and store the files that they need for finishing a work package. Further, it extends the Nextcloud dashboard with a widget for personal notifications from OpenProject. The app can also extend the search function in Nextcloud to find work packages in OpenProject." : "Bu uygulama, açık kaynaklı proje yönetimi yazılımı OpenProject ile derin bir bütünleşme sağlar. Nextcloud üzerindeki dosya ve klasörlerin OpenProject üzerindeki çalışma paketleriyle bağlanmasını sağlar. OpenProject üzerinde bir iş paketiyle ilgili tüm dosyaları görebilir ve Nextcloud üzerinde bir dosyaya bağlı tüm iş paketlerini bulabilirsiniz. Proje ekipleriniz, bir iş paketini tamamlamak için gerek duydukları dosyaları nerede bulacaklarını ve depolayacaklarını açıkça bildiklerinden üretkenlikleri artar. Ayrıca, OpenProject üzerinden gelecek kişisel bildirimleri görüntüleyen bir pano bileşeni Nextcloud panosuna eklenebilir. Uygulama ayrıca arama işlevine OpenProject üzerindeki iş paketlerini bulma özelliğini ekleyebilir.",
