OC.L10N.register(
    ...
    "Nextcloud client ID" : "Nextcloud istemci kodu",
    "Nextcloud client secret" : "Nextcloud istemci parolası",
    "Create a Nextcloud OAuth client for OpenProject" : "OpenProject için bir Nextcloud OAuth istemcisi oluştur",
    "Are you sure you want to replace the OpenProject OAuth client details?" : "OpenProject OAuth istemci ayrıntılarını değiştirmek istediğinize emin misiniz?",
    "Replace OpenProject OAuth client details" : "OpenProject OAuth istemci ayrıntılarını değiştir",
    "Replace" : "Değiştir",
    "Cancel" : "İptal",
