OC.L10N.register(
    ...
    "We recommend using this functionality but it is not mandatory. Please activate it in case you want to use the automatic creation and management of project folders." : "Bu özelliği kullanmanızı öneririz, ancak zorunlu değildir. Bu seçenek etkinse, proje klasörleri otomatik olarak oluşturulur ve yönetilir.",
    ...
    "The app will never delete files or folders, even if you deactivate this later." : "Uygulama, daha sonra devre dışı bırakısanız bile asla dosya veya klasörleri silmez.",
    ...
    "Download and enable it" : "İndirip etkinleştirin",
    ...
    "Please install the \"Group folders\" app to be able to use automatic managed folders or deactivate the automatically managed folders." : "Otomatik olarak yönetilen klasörleri etkinleştirmek veya otomatik olarak yönetilen klasörleri kullanımdan kaldırmak için lütfen \"Grup klasörleri\" uygulamasını kurun.",
    ...
    "Download and enable it here" : "İndirip buradan etkinleştirin",
