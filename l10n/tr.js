OC.L10N.register(
    ...
    "Managed project folders (recommended)" : "Yönetilen proje klasörleri (önerilir)",
    "Automatically managed folders" : "Otomatik olarak yönetilen klasörler",
    "We recommend using this functionality but it is not mandatory. Please activate in case you want to use the automatic creation and management of project folders." : "Bu özelliği kullanmanızı öneririz, ancak zorunlu değildir. Bu seçenek etkinleştirildiğinde, proje klasörleri otomatik olarak oluşturulur ve yönetilir.",
    ...
    "Edit managed project folders" : "Yönetilen proje gruplarını düzenle",
    ...
    "Keep current change" : "Geçerli değişiklikleri tut",
    "Complete without group folder setup" : "Grup klasörlerini kurmadan tamamla",
    ...
    "This value is only visible now and then never again. Copy this password to OpenProject {htmlLink} as an Administrator." : "Bu değer yalnızca şu anda görüntülenir ve bir daha asla görülemez. Bu parolayı kopyalayıp yönetici olarak OpenProject {htmlLink} sayfasına yapıştırın.",
    "Please make sure to rename the group folder or completely delete the previous one or deactivate the automatically managed folders." : "Lütfen grup klasörünü yeniden adlandırdığınızdan ya da önceki klasörü tümüyle sildiğinizden ya da otomatik olarak yönetilen klasörleri devre dışı bıraktığınızdan emin olun.",
    "Please install the group folder to be able to use automatic managed folders or deactivate the automatically managed folders." : "Lütfen otomatik yönetilen klasörleri kullanabilmek veya otomatik olarak yönetilen klasörleri devre dışı bırakabilmek için grup klasörünü kurun.",
    "Please make sure to completely delete the previous user or deactivate the automatically managed folders." : "Lütfen önceki kullanıcıyı tümüyle sildiğinizden ya da otomatik olarak yönetilen klasörleri devre dışı bıraktığınızdan emin olun.",
    "Please make sure to completely delete the previous group or deactivate the automatically managed folders." : "Lütfen önceki grubu tamamen sildiğinizden veya otomatik olarak yönetilen klasörleri devre dışı bıraktığınızdan emin olun.",
    "Something went wrong during groupfolder setup. Deactivate the automatically managed folders." : "Grup klasörü kurulumu sırasında bir sprun çıktı. Otomatik olarak yönetilen klasörleri devre dışı bırakın.",
