OC.L10N.register(
    ...
    "This application deeply integrates with the open source project management software OpenProject. It allows linking files and folders in Nextcloud with work packages in OpenProject. In OpenProject, you can see all files related to a work package, and in Nextcloud, you can find all work packages linked to a file. Your project teams gain productivity as they clearly know where to find and store the files that they need for finishing a work package. Further, it extends the Nextcloud dashboard with a widget for personal notifications from OpenProject. The app can also extend the search function in Nextcloud to find work packages in OpenProject." : "Aplikazio hau kode irekiko proiektuak kudeatzeko OpenProject softwarearekin asko integratzen da. Nextcloud-eko fitxategiak eta karpetak OpenProject-eko lan paketeekin lotzeko aukera ematen du. OpenProject-en, lan-pakete batekin erlazionatutako fitxategi guztiak ikus ditzakezu, eta Nextcloud-en, fitxategi bati lotuta dauden lan pakete guztiak aurki ditzakezu. Zure proiektu-taldeek produktibitatea lortzen dute argi eta garbi baitakite lan pakete bat amaitzeko behar dituzten fitxategiak non aurkitu eta gorde behar dituzten. Gainera, Nextcloud panela zabaltzen du OpenProject-en jakinarazpen pertsonaletarako widget batekin. Aplikazioak Nextcloud-en bilaketa-funtzioa ere zabal dezake OpenProject-en lan paketeak aurkitzeko.",
