OC.L10N.register(
    ...
    "This application enables seamless integration with open source project management and collaboration software OpenProject. On the Nextcloud end, it allows users to:\n\n* Link files and folders with work packages in OpenProject\n* Find all work packages linked to a file or folder\n* Keep an eye on updates to your work packages via the dashboard\n* Find relevant work packages using Nextcloud's search bar\n\nOn the OpenProject end, users are able to:\n\n* View all Nextcloud files linked to a work package\n* Download linked files or open them in Nextcloud to edit them\n* Unlink linked files\n\nFor more information on how to set up and use the OpenProject application, please refer to [integration setup guide](https://www.openproject.org/docs/system-admin-guide/integrations/nextcloud/) for administrators and [the user guide](https://www.openproject.org/docs/user-guide/nextcloud-integration/)." : "Aplikazio honek arazorik gabeko integrazioa ahalbidetzen du kode irekiko proiektuen kudeaketarekin eta OpenProject lankidetza-softwarearekin. Nextcloud muturrean, erabiltzaileak hurrengoa egin dezakete:\n\n* Lotu fitxategiak eta karpetak lan-paketeekin OpenProjecten\n* Fitxategi edo karpeta bati lotutako lan-pakete guztiak aurkitu\n* Zaindu zure lan-paketeen eguneratzeak panelaren bidez\n* Aurkitu lan-pakete garrantzitsuak Nextcloud bilaketa-barra erabiliz\n\nOpenProject muturrean, erabiltzaileak hurrengoa egin dezakete:\n\n* Ikusi lan-pakete bati lotuta dauden Nextcloud fitxategi guztiak \n* Fitxategi estekatuak deskargatu edo Nextcloud-en ireki editatzeko\n* Fitxategien loturak kendu\n\nOpenProject aplikazioa konfiguratu eta erabiltzeko moduari buruzko informazio gehiago nahi izanez gero, ikus [integrazioaren konfigurazio gida](https://www.openproject.org/docs/system-admin-guide/integrations/nextcloud/) administratzaileentzat eta [erabiltzaile-gida](https://www.openproject.org/docs/user-guide/nextcloud-integration/).",
