OC.L10N.register(
    ...
    "Please install the \"groupfolders\" app to be able to use automatically managed folders. {htmlLink}" : "請安裝 「groupfolders」應用程式以使用自動管理資料夾功能。{htmlLink}",
    ...
    "If you proceed this method, you will have an " : "如果您採用此方法，您將會有一個 ",
    ...
    "This feature requires version {version} (or higher) of {app}. Please install or update the app." : "此功能需要 {app} 的 {version}（或更高）版本。請安裝或更新該應用程式。",
