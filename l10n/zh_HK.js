OC.L10N.register(
    ...
    "Nextcloud integration user guide" : "Nextcloud 整合用戶指南",
    "Please go to our {htmlLink} to learn more about how to work with the OpenProject integration." : "請前往我們的{htmlLink}了解更多有關如何使用 OpenProject 整合的相關資訊。",
    ...
    "There were no workpackages found" : "沒有找到工作包",
    ...
    "This check will show \"OpenProject Icon\" in the navigation bar to navigate directly to OpenProject instance." : "此檢查將在導航欄中顯示「OpenProject 圖示」，以直接導航至 OpenProject 實例。",
    "This check will allow to unified or global search for the OpenProject tickets from the Nextcloud." : "這項檢查將允許從 Nextcloud 進行 OpenProject 票證的統一或全局搜索。",
