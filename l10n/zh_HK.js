OC.L10N.register(
    ...
    "Managed project folders (recommended)" : "託管專案資料夾（推薦）",
    "Automatically managed folders" : "自動託管的資料夾",
    "We recommend using this functionality but it is not mandatory. Please activate in case you want to use the automatic creation and management of project folders." : "我們建議使用此功能，但這不是強制性的。如果您想使用專案資料夾的自動創建和管理，請激活。",
    ...
    "Active" : "活動的",
    "Inactive" : "待用",
    "Edit managed project folders" : "編輯託管專案資料夾",
    ...
    "Keep current change" : "保留目前更新",
    "Complete without group folder setup" : "無需群組資料夾設置即可完成",
    ...
    "This value is only visible now and then never again. Copy this password to OpenProject {htmlLink} as an Administrator." : "這個值只現在可見，以後再也看不到了。以管理員身份將此密碼複製到 OpenProject {htmlLink}。",
    "Please make sure to rename the group folder or completely delete the previous one or deactivate the automatically managed folders." : "請確保重命名群組資料夾、完全刪除以前的資料夾或停用自動管理的資料夾。",
    "Please install the group folder to be able to use automatic managed folders or deactivate the automatically managed folders." : "請安裝群組資料夾以便能夠使用自動管理的資料夾或停用自動管理的資料夾。",
    "Please make sure to completely delete the previous user or deactivate the automatically managed folders." : "請確保完全刪除以前的用戶或停用自動管理的資料夾。",
    "Please make sure to completely delete the previous group or deactivate the automatically managed folders." : "請確保完全刪除之前的群組或停用自動管理的資料夾。",
    "Something went wrong during groupfolder setup. Deactivate the automatically managed folders." : "群組資料夾設置過程中出現問題。停用自動管理的資料夾。",
