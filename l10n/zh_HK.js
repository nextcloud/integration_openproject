OC.L10N.register(
    ...
    "This application enables seamless integration with open source project management and collaboration software OpenProject.\n\nOn the Nextcloud end, it allows users to:\n\n* Link files and folders with work packages in OpenProject\n* Find all work packages linked to a file or a folder\n* View OpenProject notifications via the dashboard\n* Search for work packages using Nextcloud's search bar\n* Link work packages in rich text fields via Smart Picker\n* Preview links to work packages in text fields\n* Link multiple files and folder to a work package at once\n* Create and link files and folders to a work package from Nextcloud\n\nOn the OpenProject end, users are able to:\n\n* Link work packages with files and folders in Nextcloud\n* Upload and download files directly to Nextcloud from within a work package\n* Open linked files in Nextcloud to edit them\n* Let OpenProject create shared folders per project\n\nFor more information on how to set up and use the OpenProject application, please refer to [integration setup guide](https://www.openproject.org/docs/system-admin-guide/integrations/nextcloud/) for administrators and [the user guide](https://www.openproject.org/docs/user-guide/nextcloud-integration/)." : "此應用程式啟用與開放源碼專案管理和協作軟件OpenProject的無縫整合。\n\n在Nextcloud端，它允許用戶：\n\n* 將檔案和資料夾與OpenProject中的工作軟件包連結\n* 尋找與檔案或資料夾相關聯的所有工作軟件包\n* 透過儀表板檢視OpenProject的通知\n* 使用Nextcloud的搜尋欄位搜尋工作軟件包\n* 通過智能選擇器在豐富文本欄位中連結工作軟件包\n* 在文本欄位中預覽工作軟件包的連結\n* 同時將多個檔案和資料夾連結到一個工作軟件包\n* 從Nextcloud創建並連結檔案和資料夾到工作軟件包\n\n在OpenProject端，用戶能夠：\n\n* 將工作軟件包與Nextcloud中的檔案和資料夾連結\n* 直接從工作軟件包內部上傳和下載檔案到Nextcloud\n* 在Nextcloud中打開連結的檔案以進行編輯\n* 讓OpenProject為每個專案創建共享資料夾\n\n有關如何設置和使用OpenProject應用程式的更多資訊，請參閱[整合設置指南](https://www.openproject.org/docs/system-admin-guide/integrations/nextcloud/)（供管理員使用）和[用戶指南](https://www.openproject.org/docs/user-guide/nextcloud-integration/)。"
},
"nplurals=1; plural=0;");
