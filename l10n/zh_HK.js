OC.L10N.register(
    ...
    "Save" : "保存",
    "Authorization method" : "認證方式",
    "Need help setting this up?" : "需要幫助設定這個嗎？",
    "Edit authorization method" : "編輯認證方式",
    "Authorization settings" : "授權設定",
    ...
    "This app is required to use the OIDC authorization method" : "此應用程式需要使用 OIDC 授權方法",
    ...
    "OAuth2 two-way authorization code flow" : "OAuth2 雙向授權碼流程",
    "OpenID identity provider" : "OpenID 身分提供者",
