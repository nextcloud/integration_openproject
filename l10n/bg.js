OC.L10N.register(
    ...
    "To be able to use an OpenProject server with a local address, enable the `allow_local_remote_servers` setting. {htmlLink}." : "За да можете да използвате сървър на OpenProject с локален адрес, активирайте настройката `allow_local_remote_servers`. {htmlLink}.",
