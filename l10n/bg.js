OC.L10N.register(
    ...
    "This application deeply integrates with the open source project management software OpenProject. It allows linking files and folders in Nextcloud with work packages in OpenProject. In OpenProject, you can see all files related to a work package, and in Nextcloud, you can find all work packages linked to a file. Your project teams gain productivity as they clearly know where to find and store the files that they need for finishing a work package. Further, it extends the Nextcloud dashboard with a widget for personal notifications from OpenProject. The app can also extend the search function in Nextcloud to find work packages in OpenProject." : "Това приложение се интегрира дълбоко със софтуера за управление на проекти с отворен код OpenProject. Позволява свързване на файлове и папки в приложението Nextcloud с работни пакети в OpenProject. В OpenProject можете да видите всички файлове, свързани с работен пакет, а в Nextcloud можете да намерите всички работни пакети, свързани с файл. Вашите проектни екипи печелят производителност, тъй като ясно знаят къде да намерят и съхраняват файловете, които са им необходими за завършване на работен пакет. Освен това той разширява таблото за управление на Nextcloud с изпълним модул за лични известия от OpenProject. Приложението може също да разшири функцията за търсене в Nextcloud, за да намери работни пакети в OpenProject.",
