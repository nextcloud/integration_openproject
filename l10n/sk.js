OC.L10N.register(
    ...
    "To activate audit logs for the OpenProject integration, please enable the \"{htmlLinkForAdminAudit}\" app and follow the configuration steps outlined in the {htmlLinkForDocs}." : "Ak chcete aktivovať protokoly auditu pre integráciu OpenProject, povoľte aplikáciu „{htmlLinkForAdminAudit}“ a postupujte podľa krokov konfigurácie uvedených v dokumentácii {htmlLinkForDocs}.",
    ...
    "Some OpenProject Integration application settings are not working. Configure the OpenProject Integration in: {htmlLink}" : "Niektoré nastavenia aplikácie Integrácia OpenProject nefungujú. Nakonfigurujte integráciu OpenProject na adrese: {htmlLink}",
    "Some OpenProject Integration application settings are not working. Please contact your Nextcloud administrator." : "Niektoré nastavenia aplikácie Integrácia OpenProject nefungujú. Obráťte sa na správcu Nextcloudu.",
    ...
    "authentication methods you can use with OpenProject" : "metódy overenia, ktoré môžete použiť s OpenProject",
    "Please read our guide on {htmlLink}." : "Prosím prečítajte si náš návod tu {htmlLink}.",
    "If you proceed with this method, you will have an {selectedAuthMethod} based authentication configuration which will delete all the configuration setting for current {savedAuthMethod} based authentication. You can switch back to it anytime." : "Ak budete pokračovať touto metódou, získate konfiguráciu overovania založenú na {selectedAuthMethod}, ktorá odstráni všetky nastavenia konfigurácie pre aktuálne overovanie založené na {savedAuthMethod}. Kedykoľvek sa k nemu môžete vrátiť.",
    "Switch Authentication Method" : "Prepnúť metódu overovania",
    "Yes, switch" : "Áno, prepnúť",
    ...
    "Documentation" : "Dokumentácia",
    "Accessing OpenProject servers with local addresses is not allowed." : "Prístup k serverom OpenProject s lokálnou adresou nie je povolený.",
    "To be able to use an OpenProject server with a local address, enable the `allow_local_remote_servers` setting. {htmlLink}." : "Aby ste mohli používať OpenProject server s lokálnou adresou, povoľte nastavenie `allow_local_remote_servers`. {htmlLink}. ",
    "The given URL redirects to '{location}'. Please do not use a URL that leads to a redirect." : "Daná adresa URL presmeruje na '{location}'. Nepoužívajte adresu URL, ktorá vedie k presmerovaniu.",
    "Could not connect to the given URL, please check the Nextcloud logs" : "Nepodarilo sa pripojiť k danej adrese URL, skontrolujte logy Nextcloud",
    ...
    "Active" : "Aktívne",
    "Inactive" : "Neaktívne",
    "troubleshooting guide" : "príručka na riešenie problémov",
    "Setting up the OpenProject user, group and team folder was not possible. Please check this {htmlLink} on how to resolve this situation." : "Nastavenie používateľa, skupiny a tímového priečinka OpenProject nebolo možné. V tejto {htmlLink} nájdete postup riešenia situácie.",
    "Server-side encryption is active, but encryption for Team Folders is not yet enabled. To ensure secure storage of files in project folders, please follow the configuration steps in the {htmlLink}." : "Šifrovanie na strane servera je aktívne, ale šifrovanie tímových priečinkov ešte nie je povolené. Ak chcete zaistiť bezpečné uloženie súborov v priečinkoch projektov, postupujte podľa krokov konfigurácie v dokumente {htmlLink}.",
    "This value will only be accessible once. Now, as an administrator copy this password to OpenProject {htmlLink}." : "Táto hodnota bude prístupná iba raz. Ako správca teraz skopírujte toto heslo do OpenProject: {htmlLink}.",
    ...
    "Encryption for the Team Folders App is not enabled." : "Šifrovanie aplikácie Tímové priečinky nie je povolené.",
    "Automatically managed folders:" : "Automaticky spravované adresáre:",
    "Edit project folders" : "Upraviť priečinky projektov",
    "Automatically managed folders" : "Automaticky spravované adresáre",
    ...
    "For automatically managing project folders, this app needs to setup a special team folder, assigned to a group and managed by a user, each called \"OpenProject\"." : "Na automatickú správu priečinkov projektov musí táto aplikácia nastaviť špeciálny tímový priečinok priradený skupine a spravovaný používateľom; obaja sa volajú „OpenProject“.",
    ...
    "Project folders application connection" : "Pripojenie aplikácie Priečinky projektov",
    "Application Password" : "Heslo aplikácie",
    "Done, complete setup" : "Hotovo, dokončiť nastavenie",
    "Replace application password" : "Nahradiť heslo aplikácie",
    "OpenID Connect settings" : "Nastavenia OpenID Connect",
    ...
    "This type has mandatory fields which cannot be filled here. Please, create work packages of this type directly in {htmlLink}." : "Tento typ má povinné polia, ktoré tu nemožno vyplniť. Prosím, vytvorte pracovné balíky tohto typu priamo v {htmlLink}.",
    ...
    "Install latest version now" : "Nainštalovať najnovšiu verziu teraz",
    "Download and enable it" : "Stiahnuť a povoliť",
    "This feature is not available for this user account" : "Táto funkcia nie je dostupná pre tento používateľský účet",
    ...
    "Requires an active Enterprise Corporate plan in OpenProject." : "Vyžaduje aktívny podnikový plán Enterprise Corporate v OpenProject.",
    "Please select a project" : "Prosím vyberte projekt",
    "No matching work projects found" : "Nenašli sa zodpovedajúce pracovné projekty",
    "No matching status found" : "Nenašiel sa zodpovedajúci stav",
    "No matching type found" : "Nenašiel sa zodpovedajúci typ",
    "No matching assignee found" : "Nenašiel sa zodpovedajúci riešiteľ",
    ...
    "This feature requires version {version} (or higher) of \"{app}\" app. Please install or update the app." : "Táto funkcia vyžaduje aplikáciu „{app}“ vo verzii {version} alebo novšej. Nainštalujte alebo aktualizujte aplikáciu.",
