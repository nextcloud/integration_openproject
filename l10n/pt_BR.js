OC.L10N.register(
    ...
    "This application deeply integrates with the open source project management software OpenProject. It allows linking files and folders in Nextcloud with work packages in OpenProject. In OpenProject, you can see all files related to a work package, and in Nextcloud, you can find all work packages linked to a file. Your project teams gain productivity as they clearly know where to find and store the files that they need for finishing a work package. Further, it extends the Nextcloud dashboard with a widget for personal notifications from OpenProject. The app can also extend the search function in Nextcloud to find work packages in OpenProject." : "Este aplicativo integra-se profundamente com o software de gerenciamento de projetos de código aberto OpenProject. Permite vincular arquivos e pastas no Nextcloud com pacotes de trabalho no OpenProject. No OpenProject, você pode ver todos os arquivos relacionados a um pacote de trabalho e, no Nextcloud, você pode encontrar todos os pacotes de trabalho vinculados a um arquivo. Suas equipes de projeto ganham produtividade, pois sabem claramente onde encontrar e armazenar os arquivos necessários para concluir um pacote de trabalho. Além disso, ele estende o painel Nextcloud com um widget para notificações pessoais do OpenProject. O aplicativo também pode estender a função de pesquisa no Nextcloud para encontrar pacotes de trabalho no OpenProject.",
