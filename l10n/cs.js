OC.L10N.register(
    ...
    "This application deeply integrates with the open source project management software OpenProject. It allows linking files and folders in Nextcloud with work packages in OpenProject. In OpenProject, you can see all files related to a work package, and in Nextcloud, you can find all work packages linked to a file. Your project teams gain productivity as they clearly know where to find and store the files that they need for finishing a work package. Further, it extends the Nextcloud dashboard with a widget for personal notifications from OpenProject. The app can also extend the search function in Nextcloud to find work packages in OpenProject." : "Tato aplikace do hloubky propojuje se softwarem pro správu projektů OpenProject (open source). Umožňuje spojování souborů a složek v Nextcloud s balíčky práce v OpenProject. V OpenProject je možné zobrazovat veškeré soubory související s balíčkem práce a v Nextcloud je možné najít veškeré pracovní balíčky, spojené se souborem. Váš projektový tým bude produktivnější, protože budou jasně vědět, kde hledat a uchovávat soubory, které potřebují pro dokončení balíčku práce. Dále rozšiřuje Nextcloud nástěnku o prvek s osobními upozorněními z OpenProject. Tato aplikace také může rozšířit funkci hledání v Nextcloud o hledání balíčků práce v OpenProject. ",
    ...
    "Unlink WorkPackage" : "Zrušit propojení s balíčkem práce",
