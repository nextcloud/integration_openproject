OC.L10N.register(
    ...
    "OpenProject work packages" : "OpenProject balíčky práce",
    ...
    "Keep current setup" : "Ponechat stávající uspořádání",
    "Complete without project folders" : "Dokončit bez složek projektu",
    "Setup OpenProject user, group and folder" : "Vytvořit uživatele, skupinu a složku OpenProject",
    ...
    "This value will only be accessible once. Now, as an administrator copy this password to OpenProject {htmlLink}." : "Tato hodnota bude přístupná pouze jednou. Nyní, jako správce toto heslo zkopírujte do OpenProject {htmlLink}.",
    "troubleshooting guide" : "průvodce řešením problémů",
    "Setting up the OpenProject user, group and team folder was not possible. Please check this {htmlLink} on how to resolve this situation." : "Vytvoření uživatele, skupiny a týmové složky pro OpenProject nebylo možné. Podívejte se do {htmlLink} ohledně toho, jak tuto situaci řešit.",
    ...
    "If you proceed, your old application password for the OpenProject user will be deleted and you will receive a new OpenProject user password." : "Pokud budete pokračovat, původní heslo aplikace pro OpenProject bude smazáno a obdržíte nové heslo k uživateli pro OpenProject.",
    "Replace user app password" : "Nahradit heslo uživatele pro aplikaci",
    ...
    "For automatically managing project folders, this app needs to setup a special team folder, assigned to a group and managed by a user, each called \"OpenProject\"." : "Aby bylo možné automaticky spravovat složky projektů, tato aplikace potřebuje vytvořit speciální týmovou složku, přiřazenou skupině a spravovanou uživatelem, každá nazvaná „OpenProject“.",
    ...
    "Done, complete setup" : "Hotovo, dokončit nastavení",
    "Replace application password" : "Nahradit heslo aplikace",
    ...
    "If you proceed with this method, you will have an {selectedAuthMethod} based authentication configuration which will delete all the configuration setting for current {savedAuthMethod} based authentication. You can switch back to it anytime." : "Pokud budete pokračovat s touto metodou, budete mít nastavení ověřování se založené na {selectedAuthMethod}, které smaže veškerá nastavení pro stávající ověřování se, založené na {savedAuthMethod}. Je ovšem možné kdykoli přepnout nazpět.",
    "Switch Authentication Method" : "Přepnout metodu ověřování",
    "Yes, switch" : "Ano, přepnout",
    "Authentication method" : "Metoda ověření",
    "Need help setting this up?" : "Potřebujete pomoc s nastavením tohoto?",
    "Edit authentication method" : "Upravit metodu ověřování se",
    ...
    "Please introduce your OpenProject hostname" : "Zadejte název stroje, na kterém je provozována vámi využívaná instance OpenProject",
    "Edit server information" : "Upravit informace o serveru",
    "OpenID Connect settings" : "Nastavení pro OpenID connect",
    "Authentication settings" : "Nastavení ověřování se",
    "OIDC Provider Type" : "Typ poskytovatele OIDC",
    "OIDC Provider" : "Poskytovatel OIDC",
    "Select a provider *" : "Vybrat poskytovatele *",
    "Select an OIDC provider" : "Vybrat poskytovatele OIDC",
    "OIDC provider" : "poskytovatel OIDC",
    "Edit authentication settings" : "Upravit nastavení ověřování se",
    "All terms of services are signed for user \"OpenProject\" successfully!" : "Veškeré podmínky služeb jsou pro uživatele „OpenProject“ úspěšně podepsány!",
    "Failed to sign terms of services for user \"OpenProject\"" : "Nepodařilo se podepsat podmínky používání služby pro uživatele „OpenProject“",
    "For user \"OpenProject\", several \"Terms of services\" have not been signed." : "Pro uživatele „OpenProject“ nebylo podepsáno několik „Podmínek služeb“.",
    "Sign any unsigned \"Terms Of Services\" for user \"OpenProject\"." : "Podepsat jakékoli nepodepsané „Podmínky služeb“ pro uživatele „OpenProject“.",
    "Sign Terms of services" : "Odsouhlasit všeobecné podmínky",
    "Copied!" : "Zkopírováno!",
    "Copy value" : "Zkopírovat hodnotu",
    "Copied to the clipboard" : "Zkopírováno do schránky",
    "Details" : "Podrobnosti",
    "setting up a Nextcloud file storage" : "nastavování úložiště souborů v Nextcloud",
    "Visit our documentation for in-depth information on {htmlLink} integration." : "Podrobnosti ohledně napojení na {htmlLink} naleznete v dokumentaci.",
    "user guide" : "uživatelská příručka",
    "Learn how to get the most out of the OpenProject integration by visiting our {htmlLink}." : "Zjistěte jak získat nejvíce z napojení na OpenProject navštívením našeho {htmlLink}.",
    ...
    "No matching work packages found" : "Nenalezeny žádné odpovídající balíčky práce",
    ...
    "Work package creation was not successful." : "Vytvoření balíčku práce nebylo úspěšné.",
    "Work package created successfully." : "Balíček práce úspěšně vytvořen.",
    "Link to work package created successfully!" : "Odkaz na balíček práce úspěšně vytvořen!",
    ...
    "Create and link a new work package" : "Vytvořit a propojit nový balíček práce",
    "This type has mandatory fields which cannot be filled here. Please, create work packages of this type directly in {htmlLink}." : "Tento typ má povinné kolonky, které zde není možné vyplnit. Vytvořte balíček práce tohoto typu přímo v {htmlLink}.",
    "Status is not set to one of the allowed values." : "Stav není nastavený na jednu z povolených hodnot.",
    "Project *" : "Projekt *",
    "Select a project" : "Vyberte projekt",
    "Subject *" : "Předmět *",
    "Work package subject" : "Předmět balíčku práce",
    "Type *" : "Typ *",
    "Select project type" : "Vyberte typ projektu",
    "Status *" : "Stav *",
    "Select project status" : "Vyberte stav projektu",
    "Assignee" : "Řešitel",
    "Select a user or group" : "Vybrat uživatele nebo skupinu",
    "Description" : "Popis",
    "Work package description" : "Popis balíčku práce",
    "Create" : "Vytvářet",
    "Mark as read" : "Označit jako přečtené",
    "Failed to get OpenProject notifications" : "Nepodařilo se získat upozornění z OpenProject",
    "Date alert" : "Výstraha ohledně data",
    "assignee" : "řešitel",
    ...
    "Failed to link selected files to work package" : "Nepodařilo se propojit označené soubory s balíčkem práce",
    "Retry linking remaining files" : "Znovu zkusit propojení zbývajících souborů",
    "Files selected: ${getTotalNoOfFilesSelectedInChunking}" : "Vybráno souborů: ${getTotalNoOfFilesSelectedInChunking}",
    "Files successfully linked: ${getTotalNoOfFilesAlreadyLinkedInChunking}" : "Úspěšně připojeno souborů: ${getTotalNoOfFilesAlreadyLinkedInChunking}",
    "Files failed to be linked: ${getTotalNoOfFilesNotLinkedInChunking}" : "Souborů, které se nepodařilo propojit: ${getTotalNoOfFilesNotLinkedInChunking}",
    "${getTotalNoOfFilesAlreadyLinkedInChunking} of ${getTotalNoOfFilesSelectedInChunking} files linked" : "${getTotalNoOfFilesAlreadyLinkedInChunking} z ${getTotalNoOfFilesSelectedInChunking} souborů propojeno",
    ...
    "OpenProject client ID" : "Identif. OpenProject klienta",
    "Token Exchange" : "Výměna tokenu",
    "Enable token exchange" : "Zapnout výměnu tokenu",
    "You can get this value from your identity provider when you configure the client" : "Tuto hodnotu je možné získat od poskytovatele identity, když nastavujte klienta",
    ...
    "Please select a project" : "Vyberte projekt",
    "No matching work projects found" : "Nenalezeny žádné odpovídající pracovní projekty",
    "No matching status found" : "Nenalezen žádný odpovídající stav",
    "No matching type found" : "Nenalezen žádný odpovídající typ",
    "No matching assignee found" : "Nenalezen žádný oodpovídající příjemce",
    ...
    "No matching work projects found!" : "Nenalezeny žádné odpovídající pracovní projekty!",
    "Please install the {htmlLink} app to use OIDC authentication method." : "Pokud chcete používat metodu ověřování OIDC, je třeba si nainstalovat aplikaci {htmlLink}.",
    "This app is required to use the OIDC authentication method" : "Pro používání metody ověřování OIDC je zapotřebí tato aplikace",
    "Requires OpenProject version 16.0 (or higher) and an active Corporate plan." : "Vyžaduje OpenProject verze 16.0 (a novější) a aktivní předplatné pro podniky.",
    "The \"{app}\" app is not installed" : "Aplikace „{app}“ není nainstalovaná",
    "The \"{app}\" app is not supported" : "Aplikace „{app}“ není podporovaná",
    "The \"{app}\" app is not enabled or supported" : "Aplikace „{app}“ není zapnutá nebo podporovaná",
    "Requires app version \"{minimumAppVersion}\" or later" : "Vyžaduje aplikaci verze „{minimumAppVersion}“ a novější"
},
