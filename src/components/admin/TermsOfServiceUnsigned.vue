	...
	<NcModal
		...
		<div class="tos-modal-wrapper">
			<div class="tos-modal-content">
				...
				<CheckBoldIcon  v-else fillColor="var(--color-success)" :size="60"/>
				<div class="tos-modal-content-description" >
					<p class="tos-modal-content-description-failure" v-if="!signTOSSuccessful && !this.errorMessage">Some "Terms of services" has not been signed up for user OpenProject.<br>
					Click below to sign all unsigned "Terms Of Services" for user OpenProject.</p>
					<p class="tos-modal-content-description-failure" v-else-if="!signTOSSuccessful && this.errorMessage">{{this.errorMessage}}</p>
					<p class="tos-modal-content-description-success" v-else>All the "Terms of services" signed for user OpenProject Succuessfully!"</p>
				</div>
				<div class="tos-modal-content-button">
					<NcButton v-if="!signTOSSuccessful"
						...
						{{ t('integration_openproject', this.signTOSButtonLabel) }}
					</NcButton>
					<NcButton v-else
