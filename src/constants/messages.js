...
export const messages = {
	...
	opRequiredVersionAndPlanHint: t(APP_ID, 'Requires an active Enterprise Corporate plan in OpenProject.'),
	pleaseSelectProject: t(APP_ID, 'Please select a project'),
	noMatchingWorkProjectsFound: t(APP_ID, 'No matching work projects found'),
	noMatchingStatusFound: t(APP_ID, 'No matching status found'),
	noMatchingTypeFound: t(APP_ID, 'No matching type found'),
	noMatchingAssigneeFound: t(APP_ID, 'No matching assignee found'),
	projectFolderSetup: {
		keepCurrentChange: t(APP_ID, 'Keep current setup'),
		completeWithoutProjectFolderSetup: t(APP_ID, 'Complete without project folders'),
		completeWithProjectFolderSetup: t(APP_ID, 'Setup OpenProject user, group and folder'),
		retrySetupWithProjectFolder: t(APP_ID, 'Retry setup OpenProject user, group and folder'),
	},
}
